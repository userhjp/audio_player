...
module.exports = {
    // mode: "production",
    entry: {
      audio: [path.resolve(__dirname, 'src/index.ts')], 
    ...
    output: {
        ...
        library: "AudioPlayer", // 导出库(exported library)的名称
    ...
    module: {
      rules: [
        ...
        { // 处理less
          ...
          exclude: /node_modules/,
          // use: [
          //     { loader: 'style-loader' }, // style-loader 在 DOM 里插入一个 <style> 标签，并且将 CSS 写入这个标签内。
          //     { loader: 'css-loader' }, // 处理
          //     { loader: 'less-loader' }
          // ]
          use: [
            {
